...
export function EditBookModal({
  ...
  return (
    <div className="max-h-[90vh] overflow-y-auto rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
      <button
        onClick={onClose}
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={isValidatingLocation || locationInput.trim().length < 3}
              variant="outline"
            >
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            Aktuell:{' '}
            {offer.exact_address || offer.location_district || 'Nicht gesetzt'}
          </p>
        </div>
